...
struct Motor
{
  ...
  // constructor
  Motor(const uint8_t enable, const uint8_t in1, const uint8_t in2, uint8_t sped = 100, bool dir = false)
  {
...
int kp_acc_x = 0, ki_acc_x = 0, kd_acc_x = 0;
...
//  Serial.print(acc_x);
  ...
  current_time = millis();
  elapsed_time = (current_time - previous_time); // time in sec
